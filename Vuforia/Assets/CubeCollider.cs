    ...
    private void OnCollisionStay(Collision other)
    {
        if(other.gameObject.CompareTag("Cube"))
        {
            ...
            if (int.Parse(other.gameObject.GetComponentInChildren<Text>().text) == int.Parse(gameObject.GetComponentInChildren<Text>().text))
            {
                ...
                seq1.Append(other.transform.DOJump(new Vector3(other.transform.position.x, other.transform.position.y + 3, other.transform.position.z), 0.1f, 1, 0.5f)).Join(other.transform.DORotate(new Vector3(0,180,0), 0.2F)).Insert(0.1f, other.transform.DOScale(1.5f,0.25f)).Insert(0.35f, other.transform.DOScale(1,0.25f));
                ...
                {//(int.Parse(other.gameObject.GetComponentInChildren<Text>().text) == int.Parse(hitCollider.gameObject.GetComponentInChildren<Text>().text)
                    ...
                    if (other.gameObject != hitCollider.gameObject && int.Parse(other.gameObject.GetComponentInChildren<Text>().text) == int.Parse(hitCollider.gameObject.GetComponentInChildren<Text>().text))
                    {
                        ...
                        seq2.Append(other.transform.DOJump(new Vector3(hitCollider.transform.position.x, hitCollider.transform.position.y + 3, hitCollider.transform.position.z), 1/5f, 1, 0.5f)).Join(other.transform.DORotate(new Vector3(0,180,0), 0.2F)).Insert(0.1f, other.transform.DOScale(1.5f,0.25f)).Insert(0.35f, other.transform.DOScale(1,0.25f));
